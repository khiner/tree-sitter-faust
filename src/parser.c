...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__variable, 1),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__variable, 3, .production_id = 3),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__variable, 3, .production_id = 3),
