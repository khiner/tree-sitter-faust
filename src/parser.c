...
enum {
  ...
  sym_arguments = 129,
  sym__argument = 130,
  sym_recursive_arg = 131,
  sym_sequential_arg = 132,
  sym_split_arg = 133,
  sym_merge_arg = 134,
  sym_iteration = 135,
  sym_with_environment = 136,
  sym_environment = 137,
  sym_letrec_environment = 138,
  sym_rec_environment = 139,
  sym_recinition = 140,
  sym_substitution = 141,
  sym_substitutions = 142,
  sym_component = 143,
  sym__infix = 144,
  sym__prim1 = 145,
  sym__prim2 = 146,
  ...
  sym__prim5 = 149,
  sym__modifier = 150,
  sym_one_sample_delay = 151,
  sym_sub = 152,
  sym__number = 153,
  sym_documentation = 154,
  sym__doc_content = 155,
  sym__special_doc_tag = 156,
  sym__binary_composition = 157,
  sym_recursive = 158,
  sym_sequential = 159,
  sym_split = 160,
  sym_merge = 161,
  ...
  aux_sym_environment_repeat1 = 170,
  aux_sym_rec_environment_repeat1 = 171,
  aux_sym_documentation_repeat1 = 172,
  aux_sym_variants_repeat1 = 173,
  aux_sym_id_repeat1 = 174,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_variants] = STATE(151),
    [sym__variant] = STATE(117),
    [sym_id] = STATE(172),
    [aux_sym_program_repeat1] = STATE(89),
    [aux_sym_variants_repeat1] = STATE(117),
  ...
  [22] = {
    ...
    [sym_recursive_arg] = STATE(146),
    [sym_sequential_arg] = STATE(146),
    [sym_split_arg] = STATE(146),
    [sym_merge_arg] = STATE(146),
    [sym_iteration] = STATE(53),
    [sym_substitution] = STATE(53),
    [sym_component] = STATE(53),
    [sym__infix] = STATE(66),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitutions, 2),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_substitutions, 2),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 4, .production_id = 15),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 4, .production_id = 15),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix, 6, .production_id = 21),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prefix, 6, .production_id = 21),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component, 4),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_component, 4),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_environment, 3),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_environment, 3),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__primitive, 8),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__primitive, 8),
  ...
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_iteration, 8, .production_id = 22),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_iteration, 8, .production_id = 22),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access, 3, .production_id = 11),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_access, 3, .production_id = 11),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitutions, 3),
  [224] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_substitutions, 3),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_partial, 4, .production_id = 16),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_partial, 4, .production_id = 16),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prim1, 4, .production_id = 17),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prim1, 4, .production_id = 17),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prim2, 4, .production_id = 18),
  [236] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prim2, 4, .production_id = 18),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_environment, 2),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_environment, 2),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__primitive, 3),
  [244] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__primitive, 3),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prim3, 4, .production_id = 18),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prim3, 4, .production_id = 18),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__primitive, 2),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__primitive, 2),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prim4, 4, .production_id = 18),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prim4, 4, .production_id = 18),
  ...
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution, 2, .production_id = 6),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_substitution, 2, .production_id = 6),
  ...
  [276] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(163),
  ...
  [285] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(117),
  ...
  [303] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_environment_repeat1, 2), SHIFT_REPEAT(133),
  ...
  [348] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_import, 5, .production_id = 8),
  [350] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file_import, 5, .production_id = 8),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__definition, 2),
  [354] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__definition, 2),
  ...
  [360] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_documentation, 2),
  [362] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_documentation, 2),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_documentation, 3),
  [366] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_documentation, 3),
  ...
  [372] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_variants_repeat1, 2),
  [374] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variants_repeat1, 2), SHIFT_REPEAT(108),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variants_repeat1, 2),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rec_environment, 2),
  [381] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rec_environment, 2),
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parallel, 3, .production_id = 9),
  [385] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [387] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [389] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_parallel, 3, .production_id = 9),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_recursive, 3, .production_id = 9),
  [393] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_recursive, 3, .production_id = 9),
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequential, 3, .production_id = 9),
  [397] = {.entry = {.count = 1, .reusable = false}}, SHIFT(8),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_split, 3, .production_id = 9),
  [401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [403] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_merge, 3, .production_id = 9),
  [407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_with_environment, 3, .production_id = 10),
  [409] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_with_environment, 3, .production_id = 10),
  [411] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_letrec_environment, 3, .production_id = 10),
  [413] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_letrec_environment, 3, .production_id = 10),
  ...
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rec_environment, 4),
  [423] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rec_environment, 4),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rec_environment, 3),
  [427] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rec_environment, 3),
  [429] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rec_environment, 5),
  [431] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rec_environment, 5),
  [433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 4, .production_id = 5),
  ...
  [441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3, .production_id = 2),
  ...
  [449] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_id_repeat1, 2), SHIFT_REPEAT(179),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 7, .production_id = 20),
  [454] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 6, .production_id = 19),
  [456] = {.entry = {.count = 1, .reusable = false}}, SHIFT(136),
  [458] = {.entry = {.count = 1, .reusable = true}}, SHIFT(80),
  [460] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variants_repeat1, 2), SHIFT_REPEAT(136),
  ...
  [479] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_merge_arg, 3, .production_id = 9),
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_split_arg, 3, .production_id = 9),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequential_arg, 3, .production_id = 9),
  [485] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_recursive_arg, 3, .production_id = 9),
  [487] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_recursive_arg, 3, .production_id = 9),
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2),
  ...
  [505] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rec_environment_repeat1, 2),
  [507] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rec_environment_repeat1, 2), SHIFT_REPEAT(157),
  ...
  [516] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 2),
  [518] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [520] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2, .production_id = 3),
  [522] = {.entry = {.count = 1, .reusable = true}}, SHIFT(160),
  [524] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_recinition, 5, .production_id = 23),
  [526] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_arguments_repeat1, 2), SHIFT_REPEAT(20),
  [529] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2),
  [531] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(160),
  [534] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 1, .production_id = 3),
  ...
  [548] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, .production_id = 13),
  ...
  [566] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_metadata, 3, .production_id = 1),
  ...
  [602] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_metadata, 4, .production_id = 4),
