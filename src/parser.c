...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix_op, 3, .production_id = 7),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_infix_op, 3, .production_id = 7),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_sample_delay, 1),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_one_sample_delay, 1),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__primitive, 8),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__primitive, 8),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_op, 4, .production_id = 9),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prefix_op, 4, .production_id = 9),
  ...
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modifier_op, 2),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_modifier_op, 2),
