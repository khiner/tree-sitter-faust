...
enum {
  ...
  sym__prim1 = 131,
  sym__prim2 = 132,
  sym__modifier_op = 133,
  sym_sub_op = 134,
  sym_one_sample_delay_op = 135,
  sym__number = 136,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_exp_op] = ACTIONS(35),
    [sym_log_op] = ACTIONS(35),
    [sym_log10_op] = ACTIONS(35),
    [sym_sqrt_op] = ACTIONS(35),
    [sym_abs_op] = ACTIONS(35),
    [sym_floor_op] = ACTIONS(35),
    [sym_ceil_op] = ACTIONS(35),
    [sym_rint_op] = ACTIONS(35),
    [sym_round_op] = ACTIONS(35),
    [sym_acos_op] = ACTIONS(35),
    [sym_asin_op] = ACTIONS(35),
    [sym_atan_op] = ACTIONS(35),
    [sym_cos_op] = ACTIONS(35),
    [sym_sin_op] = ACTIONS(35),
    [sym_tan_op] = ACTIONS(35),
    [sym_int_cast] = ACTIONS(35),
    [sym_float_cast] = ACTIONS(35),
    [sym_pow_fun_op] = ACTIONS(37),
    [sym_min_op] = ACTIONS(37),
    [sym_max_op] = ACTIONS(37),
    [sym_fmod_op] = ACTIONS(37),
    [sym_remainder_op] = ACTIONS(37),
    [sym_atan2_op] = ACTIONS(37),
    [sym_delay_op] = ACTIONS(33),
    [sym_prefix_op] = ACTIONS(37),
    [sym_attach_op] = ACTIONS(37),
    [sym_enable_op] = ACTIONS(37),
    [sym_control_op] = ACTIONS(37),
    [sym_wire] = ACTIONS(39),
    [sym_cut] = ACTIONS(39),
    [sym_mem] = ACTIONS(39),
    [sym_int] = ACTIONS(39),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub_op, 1),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sub_op, 1),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier, 2),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier, 2),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_identifier_repeat1, 2),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_identifier_repeat1, 2),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_identifier_repeat1, 2), SHIFT_REPEAT(185),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier, 3),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier, 3),
  ...
  [395] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_identifier_repeat1, 2), SHIFT_REPEAT(174),
